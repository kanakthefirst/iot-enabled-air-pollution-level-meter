...
const ADC_Config ADC_config[CONFIG_ADC_COUNT] = {
    ...
    /* Analog Input 4 */
    {
        ...
        .object = &adcCC32XXObjects[CONFIG_ADC_135],
        .hwAttrs = &adcCC32XXHWAttrs[CONFIG_ADC_135]
    },
    /* CONFIG_ADC_2 */
    /* Analog Input 3 */
    {
...
const uint_least8_t CONFIG_ADC_135_CONST = CONFIG_ADC_135;
...
GPIO_PinConfig gpioPinConfigs[33] = {
    ...
    GPIO_CFG_INPUT | GPIOCC32XX_DO_NOT_CONFIG,
    GPIO_CFG_INPUT | GPIOCC32XX_DO_NOT_CONFIG,
    /* Owned by CONFIG_ADC_2 as ADC Pin */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_ADC_2_AIN */
    /* Owned by CONFIG_ADC_135 as ADC Pin */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_ADC_135_AIN */
    GPIO_CFG_INPUT | GPIOCC32XX_DO_NOT_CONFIG,
    GPIO_CFG_INPUT | GPIOCC32XX_DO_NOT_CONFIG,
    GPIO_CFG_INPUT | GPIOCC32XX_DO_NOT_CONFIG,
...
const uint_least8_t CONFIG_GPIO_ADC_135_AIN_CONST = CONFIG_GPIO_ADC_135_AIN;
const uint_least8_t CONFIG_GPIO_ADC_2_AIN_CONST = CONFIG_GPIO_ADC_2_AIN;
